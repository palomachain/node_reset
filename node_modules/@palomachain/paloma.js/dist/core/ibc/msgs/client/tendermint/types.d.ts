import { Header as Header_pb, SignedHeader as SignedHeader_pb, BlockID as BlockID_pb, PartSetHeader as PartSetHeader_pb, Commit as Commit_pb, CommitSig as CommitSig_pb, BlockIDFlag } from '@palomachain/paloma.proto/tendermint/types/types';
import { Validator as Validator_pb, ValidatorSet as ValidatorSet_pb } from '@palomachain/paloma.proto/tendermint/types/validator';
