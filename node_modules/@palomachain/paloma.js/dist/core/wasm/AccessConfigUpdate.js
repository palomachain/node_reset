...
var proposal_1 = require("@palomachain/paloma.proto/cosmwasm/wasm/v1/proposal");
...
var AccessConfigUpdate = /** @class */ (function (_super) {
    ...
    AccessConfigUpdate.fromAmino = function (data) {
        return new AccessConfigUpdate(Number.parseInt(data.code_id), data.instantiate_permission
            ? AccessConfig_1.AccessConfig.fromAmino(data.instantiate_permission)
            : undefined);
    };
    ...
    AccessConfigUpdate.fromData = function (data) {
        return new AccessConfigUpdate(Number.parseInt(data.code_id), data.instantiate_permission
            ? AccessConfig_1.AccessConfig.fromData(data.instantiate_permission)
            : undefined);
    };
    ...
    AccessConfigUpdate.fromProto = function (proto) {
        return new AccessConfigUpdate(proto.codeId.toNumber(), proto.instantiatePermission
