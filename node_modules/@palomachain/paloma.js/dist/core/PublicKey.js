...
var keys_1 = require("@palomachain/paloma.proto/cosmos/crypto/multisig/keys");
var any_1 = require("@palomachain/paloma.proto/google/protobuf/any");
var keys_2 = require("@palomachain/paloma.proto/cosmos/crypto/secp256k1/keys");
var keys_3 = require("@palomachain/paloma.proto/cosmos/crypto/ed25519/keys");
...
var SimplePublicKey = /** @class */ (function (_super) {
    ...
    SimplePublicKey.prototype.address = function () {
        return bech32_1.bech32.encode('paloma', bech32_1.bech32.toWords(this.rawAddress()));
    };
    SimplePublicKey.prototype.pubkeyAddress = function () {
        return bech32_1.bech32.encode('palomapub', bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
...
var ValConsPublicKey = /** @class */ (function (_super) {
    ...
    ValConsPublicKey.prototype.address = function () {
        return bech32_1.bech32.encode('palomavalcons', bech32_1.bech32.toWords(this.rawAddress()));
    };
    ValConsPublicKey.prototype.pubkeyAddress = function () {
        return bech32_1.bech32.encode('palomavalconspub', bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
