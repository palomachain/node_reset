...
exports.MnemonicKey = exports.PALOMA_COIN_TYPE = void 0;
var bip32 = __importStar(require("bip32"));
var bip39 = __importStar(require("bip39"));
var RawKey_1 = require("./RawKey");
exports.PALOMA_COIN_TYPE = 118;
var DEFAULT_OPTIONS = {
    account: 0,
    index: 0,
    coinType: exports.PALOMA_COIN_TYPE,
};
/**
...
var MnemonicKey = /** @class */ (function (_super) {
    ...
    function MnemonicKey(options) {
        ...
        var palomaHD = masterKey.derivePath(hdPathLuna);
        var privateKey = palomaHD.privateKey;
        if (!privateKey) {
