...
var WasmAPI = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.lcd.config.isClassic) {
                    endpoint_1 = "/paloma/wasm/v1beta1/codes/".concat(codeID);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (this.lcd.config.isClassic) {
                            endpoint_2 = "/paloma/wasm/v1beta1/contracts/".concat(contractAddress);
                            return [2 /*return*/, this.c
    ...
    WasmAPI.prototype.contractQuery = function (contractAddress, query, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.lcd.config.isClassic) {
                    endpoint = "/paloma/wasm/v1beta1/contracts/".concat(contractAddress, "/store");
                    return [2 /*return*/, this.c
    ...
    WasmAPI.prototype.parameters = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        .get("/paloma/wasm/v1beta1/params", params)
                        .then(function (_a) {
                        var d = _a.params;
                        return ({
